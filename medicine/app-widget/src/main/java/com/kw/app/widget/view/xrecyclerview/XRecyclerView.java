...
public class XRecyclerView extends RecyclerView {
    ...
    /**
     * @Description 没有更多数据的提示语
     **/
    public void setNoMore(String result){
        this.isNoMore = true;
        View footView = mFootViews.get(0);
        ((LoadingMoreFooter) footView).setState(LoadingMoreFooter.STATE_NOMORE,result);
    }
    ...
    public void refreshComplete(String result) {
        mRefreshHeader.refreshComplete(result);
    }
